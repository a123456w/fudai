...
public class PayFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static final String EXTRA_HINT = "EXTRA_HINT";          // 提示信息
    public static final String EXTRA_CASH = "EXTRA_CASH";          // 金额
    ...
    private void initView(Dialog dialog) {
        ...
        if (bundle != null) {
            ...
            TextView tv_Cash = (TextView) dialog.findViewById(R.id.tv_cash);
            TextView tv_hint = (TextView) dialog.findViewById(R.id.tv_hint);
            tv_hint.setText(bundle.getString(EXTRA_HINT));
            tv_Cash.setText(bundle.getString(EXTRA_CASH));
