...
public class MNCalendarVerticalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MNCalendarVerticalAdapter(Context context, HashMap<String, ArrayList<MNCalendarItemModel>> mDatas,
                                     Calendar currentCalendar, MNCalendarVerticalConfig mnCalendarVerticalConfig, SetData setData) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (mnCalendarVerticalConfig.isGridItemDividerDecoration()){
                myViewHolder.recyclerViewItem.addItemDecoration(new GridItemDividerDecoration(context.getResources().getDrawable(mnCalendarVerticalConfig.getGridItemDividerDecorationDrawable()), GridItemDividerDecoration.VERTICAL, mnCalendarVerticalConfig.getGridItemDividerDecorationWeight()));
                //myViewHolder.v_lin.setVisibility(View.VISIBLE);
            }
            //初始化Adapter
    ...
    private static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            //v_lin = (RecyclerView) itemView.findViewById(R.id.v_lin);
        }
    }
