...
public class MNCalendarVerticalConfig {
    ...
    //是否显示阴历
    private boolean mnCalendar_showLunar = false;
    //是否显示星期栏
    ...
    //开始结束的背景颜色
    private int mnCalendar_colorStartAndEndBg = Color.parseColor("#ff90c42f");
    //区间中间的背景颜色
    private int mnCalendar_colorRangeBg = Color.parseColor("#9990c42f");
    //区间文字的颜色
    private int mnCalendar_colorRangeText = Color.parseColor("#FFFFFF");
    //显示多少月(默认6个月)
    private int mnCalendar_countMonth = 6;
    // 是否显示横向下划线  纵向懒得写
    private boolean gridItemDividerDecoration =true;
    // 下划线颜色
    private int gridItemDividerDecorationDrawable = R.drawable.divider_underline;
    // 下划线宽度
    private int gridItemDividerDecorationWeight = 1;

    public int getGridItemDividerDecorationWeight() {
        return gridItemDividerDecorationWeight;
    }

    public void setGridItemDividerDecorationWeight(int gridItemDividerDecorationWeight) {
        this.gridItemDividerDecorationWeight = gridItemDividerDecorationWeight;
    }



    public int getGridItemDividerDecorationDrawable() {
        return gridItemDividerDecorationDrawable;
    }

    public void setGridItemDividerDecorationDrawable(int gridItemDividerDecorationDrawable) {
        this.gridItemDividerDecorationDrawable = gridItemDividerDecorationDrawable;
    }



    public boolean isGridItemDividerDecoration() {
        return gridItemDividerDecoration;
    }

    public void setGridItemDividerDecoration(boolean gridItemDividerDecoration) {
        this.gridItemDividerDecoration = gridItemDividerDecoration;
    }
