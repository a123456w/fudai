...
import com.maning.calendarlibrary.adapter.SetData;
...
public class MNCalendarVertical extends LinearLayout {
    ...
    private void init() {
        // TODO: 2018/5/9 0009   这个修改状态
        setData = new SetData();
//               private String currentState = "1";   表示 默认今天是入店。明天是离店
        //        private String currentState = "2";   表示 默认今天是入店和离店2个状态
...
//        }
    ...
    private void initAdapter() {
        ...
        if (mnCalendarVerticalAdapter == null) {
            mnCalendarVerticalAdapter = new MNCalendarVerticalAdapter(context, dataMap, currentCalendar, mnCalendarVerticalConfig, setData);
