...
public class LuckyBagListServiceFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener,OnItemChildClickListener,OnRVItemClickListener {
    ...
    public void getData() {
        isLazy = false;
        getListData(new PreferencesHelper(mContext).getToken(),"5",page);
    }
