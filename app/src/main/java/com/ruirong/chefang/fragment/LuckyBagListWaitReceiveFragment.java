...
public class LuckyBagListWaitReceiveFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener, OnItemChildClickListener, OnRVItemClickListener, PayPwdView.InputCallBack {
    ...
    public void getData() {
        isLazy = true;
        getListData(new PreferencesHelper(mContext).getToken(), "3", page);
    }
...
//                ToastUtil.showToast(mContext, "联系卖家");
    ...
    public void onInputFinish(String result) {
        config(new PreferencesHelper(getActivity()).getToken(), adapter.getItem(itemPosition).getNumber_bh(), result);
    }
}
