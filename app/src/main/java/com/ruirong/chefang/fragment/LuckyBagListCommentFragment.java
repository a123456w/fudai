...
public class LuckyBagListCommentFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener,OnItemChildClickListener,OnRVItemClickListener {
    ...
    public void getData() {
        isLazy = true;
        getListData(new PreferencesHelper(mContext).getToken(),"4",page);
    }
