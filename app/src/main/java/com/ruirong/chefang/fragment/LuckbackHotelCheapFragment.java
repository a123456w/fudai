 ...
 * describe: 福返酒店 实惠
 */
public class LuckbackHotelCheapFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener, OnRVItemClickListener {
    ...
    public void getData() {
        getListData(new PreferencesHelper(getContext()).getLatitude(),
                new PreferencesHelper(getContext()).getLongTitude(), "3", page);
    }
                        ...
                        if (baseBean.code == 0) {
                            ...
                            if (page == 1) {
                                ...
                                if (baseList != null && baseList.size() > 0) {
                                    ...
                                    LuckbackHotelCheapFragment.this.page--;
