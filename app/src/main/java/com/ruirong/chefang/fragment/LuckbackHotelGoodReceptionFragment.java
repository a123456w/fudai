 ...
 * Created by chenlipeng on 2017/12/27 0027
   describe: 福返酒店 好评
 */
public class LuckbackHotelGoodReceptionFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener, OnRVItemClickListener {
    ...
    public void getData() {
        getListData(new PreferencesHelper(getContext()).getLatitude(),
                new PreferencesHelper(getContext()).getLongTitude(), "2", page);
    }
                        ...
                        if (baseBean.code == 0) {
                            ...
                            if (page == 1) {
                                ...
                                if (baseList != null && baseList.size() > 0) {
                                    ...
                                    LuckbackHotelGoodReceptionFragment.this.page--;
