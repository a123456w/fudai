...
import com.ruirong.chefang.adapter.ShopOrderDeliverAdapter;
...
public class ShopOrderListWaitCommentFragment extends BaseFragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener, OnRVItemClickListener, OnItemChildClickListener {
    ...
    private ShopOrderDeliverAdapter adapter;
    ...
    public void initView() {
        ...
        adapter = new ShopOrderDeliverAdapter(canContentView);
    ...
    public void getData() {
        isLazy = true;
        getListData(helper.getToken(),4,page);
    }
