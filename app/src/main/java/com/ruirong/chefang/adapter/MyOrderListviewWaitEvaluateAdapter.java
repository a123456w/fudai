...
import com.ruirong.chefang.personalcenter.LogisticsDetailsActivity;
import com.ruirong.chefang.personalcenter.PublishCommentActivity;
...
public class MyOrderListviewWaitEvaluateAdapter extends RecyclerViewAdapter<SpecialtyOrderBean> {
    private SpecialtyOrderGoodsListAdapter specialtyOrderGoodsListAdapter;

    public MyOrderListviewWaitEvaluateAdapter(RecyclerView recyclerView) {
        super(recyclerView, R.layout.my_order_listview_item_wait_evaluate);
    }
